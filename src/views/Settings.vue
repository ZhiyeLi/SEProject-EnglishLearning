            ...
            <div class="space-y-4">
              ...
              >
                ...
                <div class="flex gap-2 flex-shrink-0 ml-4">
                  <button
                    class="px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg transition-colors text-sm"
                  >
                    CSV
                  </button>
                  <button
              ...
              >
                ...
                <button
                  class="px-4 py-2 bg-yellow-50 hover:bg-yellow-100 text-yellow-700 rounded-lg transition-colors flex-shrink-0 ml-4"
                >
                  清空
                </button>
              </div>
...
const saveSettings = () => {
  try {
    ...
    message.className =
      "fixed top-4 right-4 bg-emerald-500 text-white px-6 py-3 rounded-lg shadow-lg animate-bounce";
...
const navItems = [
  ...
  {
    label: "单词打卡",
    onClick: () => router.push({ name: "WordTypeSelection" }).catch(() => {}),
  },
  {
    label: "AI伴学",
    onClick: () => router.push({ name: "AiChat" }).catch(() => {}),
  },
];
</script>
