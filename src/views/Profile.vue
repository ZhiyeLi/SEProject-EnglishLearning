<template>
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="container mx-auto px-4 -mt-20 relative z-10">
      <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-shrink-0">
          <div
            class="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white shadow-md overflow-hidden"
          >
            <img
        ...
        <div class="flex-grow">
          <div
            class="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100"
          >
            <div>
              ...
              <div class="flex items-center mt-3 text-sm text-gray-500">
                <span class="flex items-center mr-4">
                  <i class="fas fa-calendar-alt mr-1" /> 加入于
                  {{ userStore.userInfo.joinTime }}
                </span>
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-4">
              <div class="flex gap-3 pb-4 border-b border-gray-100">
                <div
                  class="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-1"
                >
                ...
                <div>
                  <p class="text-gray-800">
                    完成了
                    <span class="font-medium">英语四级单词</span> 学习任务
                  </p>
              ...
              <div class="flex gap-3 pb-4 border-b border-gray-100">
                ...
                <div>
                  <p class="text-gray-800">
                    向
                    <span class="font-medium">AI 学习助手</span> 咨询了语法问题
                  </p>
                  <p class="text-sm text-gray-500 mt-1">
                    昨天 16:20
                  </p>
              ...
              <div class="flex gap-3">
                <div
                  class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0 mt-1"
                >
    ...
    <!-- 编辑资料对话框（引入组件） -->
    <EditProfile v-model:open="isEditOpen" /><!-- 双向绑定对话框显示状态 -->
  </div>
</template>
